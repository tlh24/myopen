function limits = shoulder_adduct(limits,deg)
%SHOULDER_ADDUCT is a function that only works in conjunction with the virtual arm system.
%
%   limits = SHOULDER_ADDUCT(limits,deg) where deg is a number performs a shoulder adduction   
...
%
%   limits = SHOULDER_ADDUCT(limits,deg) where deg is an ASCII character performs a shoulder   
...
% 
%   limits = SHOULDER_ADDUCT(limits) performs a shoulder adduction on the virtual arm by a

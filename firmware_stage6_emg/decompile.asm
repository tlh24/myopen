...
ffa09926:	0a e1 20 08 	P2.L = 0x820;		/* (2080)	P2=0xffc00820(-4192224) */
ffa0992a:	20 e1 03 34 	R0 = 0x3403 (X);		/*		R0=0x3403(13315) */
ffa0992e:	10 97       	W[P2] = R0;
ffa09930:	24 00       	SSYNC;
ffa09932:	4a e1 c0 ff 	P2.H = 0xffc0;		/* (-64)	P2=0xffc00820(-4192224) */
ffa09936:	0a e1 00 08 	P2.L = 0x800;		/* (2048)	P2=0xffc00800(-4192256) */
ffa0993a:	20 e1 03 66 	R0 = 0x6603 (X);		/*		R0=0x6603(26115) */
...
ffa0995e:	05 20       	JUMP.S 0xffa09968 <_main+0x114>;
	...
ffa09968:	4a e1 c0 ff 	P2.H = 0xffc0;		/* (-64)	P2=0xffc00800(-4192256) */
...
ffa09984:	20 e1 04 fe 	R0 = -0x1fc (X);		/*		R0=0xfffffe04(-508) */
...
ffa099e0:	f8 60       	R0 = 0x1f (X);		/*		R0=0x1f( 31) */
ffa099e2:	80 4f       	R0 <<= 0x10;

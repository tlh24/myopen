...
GOBJS = src/icms.pb.o src/gtkclient.o src/gettime.o src/glInfo.o \
src/matStor.o src/icmswriter.o  
...
clean:
	rm -rf gtkclient spikes2mat icms2mat mmap_test po8e wf_plot \

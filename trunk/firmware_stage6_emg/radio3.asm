...
// see memory.h for FP_BASE
#define FP_CHAN		4
#define FP_TXCHAN		8
#define FP_EXCEEDED	12
#define FP_QS			16
...
_get_asm: 
	...
	r6 = [FP - FP_CHAN]; //hence this variable need start at 31.
	r6 += 1; 
	bitclr(r6, 5); 
	[FP - FP_CHAN] = r6; 
...
_radio_bidi_asm:
	...
	i0.l = LO(A1); 
	i0.h = HI(A1);
	l0 = 1024; //have: 32 channels, 4 biquads, 4 coef each, 
	m0 = 0; //each coef is 2 bytes = 1024 bytes. 
	b0 = i0; //or: 16 chan, 16 4-bytes reads.  
...
lt_top:
	//lowpass biquad.
	r0 = 2561 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 5122 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 20676 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -10069 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	
	//highpass biquad.
	r0 = 15855 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -31710 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 32109 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -15766 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	
	//lowpass biquad.
	r0 = 2561 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 5121 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 16248 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -4404 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	
	//highpass biquad.
	r0 = 15855 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -31710 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = 31275 (x); w[i0++] = r0.l; w[i0++] = r0.l;
	r0 = -14930 (x); w[i0++] = r0.l; w[i0++] = r0.l;
lt_bot: nop; 

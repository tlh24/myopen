function limits = shoulder_extend(limits,deg)
%SHOULDER_SUPINATE is a function that only works in conjunction with the virtual arm system.
%
%   limits = SHOULDER_SUPINATE(limits,deg) where deg is a number performs a shoulder supination   
...
%
%   limits = SHOULDER_SUPINATE(limits,deg) where deg is an ASCII character performs a shoulder   
...
% 
%   limits = SHOULDER_SUPINATE(limits) performs a shoulder supination on the virtual arm by a

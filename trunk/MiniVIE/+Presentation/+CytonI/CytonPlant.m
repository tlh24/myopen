classdef CytonPlant < hgsetget
    ...
    methods
        ...
        function reset(obj)
            ...
            obj.DesiredSpeed = obj.DefaultSpeed*ones(CytonPlant.NumJoints,1);
            obj.DesiredPosition = obj.DefaultPosition*ones(CytonPlant.NumJoints,1);
            obj.CurrentPosition = obj.DefaultPosition*ones(CytonPlant.NumJoints,1);

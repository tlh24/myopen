classdef HandStateHook < Controls.HandState
    methods
        function obj = HandStateHook
            obj.initialize();
            obj.Name = mfilename;
        end
        function updateState(obj)
            ...
            switch obj.CurrentState
                ...
                case Controls.HandStateEnum.Platform
                    if (obj.Actuators.MiddleRingLittle.Position > 0.35) && (obj.Actuators.Index.Position > 0.35)
                ...
                case Controls.HandStateEnum.Point
                    ...
                    elseif (obj.Actuators.MiddleRingLittle.Position > 0.9) && obj.Actuators.Index.Position > 0.9 && (obj.Actuators.ThumbAdAb.Position < 0.15)
                        obj.setState(Controls.HandStateEnum.Hook);
                    elseif obj.Actuators.ThumbAdAb.Position > (6/8)
                        obj.setState(Controls.HandStateEnum.Opposition);
                    end
                    
                case Controls.HandStateEnum.PointExtend
                    if obj.Actuators.Index.Position < 0.05
                        obj.setState(Controls.HandStateEnum.Point);
                    end
                    
                case Controls.HandStateEnum.Hook
                    if obj.Actuators.ThumbFE.Position > 0.6
                        obj.setState(Controls.HandStateEnum.Key);
                    elseif (obj.Actuators.MiddleRingLittle.Position > 0.95) && (obj.Actuators.Index.Position > 0.95)
                        obj.setState(Controls.HandStateEnum.PointExtend);
                    elseif (obj.Actuators.Index.Position < 0.3) && (obj.Actuators.MiddleRingLittle.Position < 0.3) && obj.Actuators.ThumbAdAb.Position < (1/8)
                        obj.setState(Controls.HandStateEnum.Platform);
                    end
        ...
        function setState(obj, newState)
            ...
            switch newState
                case Controls.HandStateEnum.Platform
                    ...
                    obj.ActiveJoints = {'Index', 'MiddleRingLittle'};
                case Controls.HandStateEnum.Point
                    %obj.Actuators.Index.InputSrc            = obj.Input.UP_DOWN;
                    obj.Actuators.MiddleRingLittle.InputSrc = obj.Input.UP_DOWN;

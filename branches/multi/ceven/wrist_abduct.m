function limits = wrist_abduct(limits,deg)
%WRIST_ABDUCT is a function that only works in conjunction with the virtual arm system.
%
%   limits = WRIST_ABDUCT(limits,deg) where deg is a number performs a wrist abduction   
...
%
%   limits = WRIST_ABDUCT(limits,deg) where deg is an ASCII character performs a wrist  
...
% 
%   limits = WRIST_ABDUCT(limits) performs a wrist abduction on the virtual arm by a

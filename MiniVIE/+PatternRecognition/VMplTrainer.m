classdef VMplTrainer < PatternRecognition.TrainingInterface
    ...
    methods
        ...
        function collectdata(obj)
            ...
            set(obj.hFig,'Position', [screensize(4)/20 screensize(4)*3/12 500 400]);
            
            obj.hFig.Color = 'k';
            obj.hAxes.Color = 'k';
            
            obj.hAxes.Position = [0.1300 0.0100 0.7750 0.8150];
            obj.hText = uicontrol(obj.hFig,'Style','Text','Units','Normalized','Position',[0.13 0.88 0.7750 0.12]);
            obj.hText.ForegroundColor = [0.8 0.8 0.8];
            obj.hText.BackgroundColor = 'k';
            obj.hText.String = '00:00';
            obj.hText.FontSize = 32;

function limits = wrist_pronate(limits,deg)
%WRIST_PRONATE is a function that only works in conjunction with the virtual arm system.
%
%   limits = WRIST_PRONATE(limits,deg) where deg is a number performs a wrist pronation   
...
%
%   limits = WRIST_PRONATE(limits,deg) where deg is an ASCII character performs a wrist   
...
% 
%   limits = WRIST_PRONATE(limits) performs a wrist pronation on the virtual arm by a
